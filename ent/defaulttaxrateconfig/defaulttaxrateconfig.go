...
const (
	// Label holds the string label denoting the defaulttaxrateconfig type in the database.
	Label = "default_tax_rate_config"
	...
	// Table holds the table name of the defaulttaxrateconfig in the database.
	Table = "default_tax_rate_configs"
)

// Columns holds all SQL columns for defaulttaxrateconfig fields.
var Columns = []string{
	FieldID,
	FieldTenantID,
	FieldStatus,
...
// OrderOption defines the ordering options for the DefaultTaxRateConfig queries.

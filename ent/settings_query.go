...
func (sq *SettingsQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (sq *SettingsQuery) FirstIDX(ctx context.Context) string {
...
func (sq *SettingsQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (sq *SettingsQuery) OnlyIDX(ctx context.Context) string {
...
func (sq *SettingsQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (sq *SettingsQuery) IDsX(ctx context.Context) []string {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(settings.FieldTenantID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
func (sq *SettingsQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(settings.Table, settings.Columns, sqlgraph.NewFieldSpec(settings.FieldID, field.TypeString))
	_spec.From = sq.sql

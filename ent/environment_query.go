...
func (eq *EnvironmentQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (eq *EnvironmentQuery) FirstIDX(ctx context.Context) string {
...
func (eq *EnvironmentQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (eq *EnvironmentQuery) OnlyIDX(ctx context.Context) string {
...
func (eq *EnvironmentQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (eq *EnvironmentQuery) IDsX(ctx context.Context) []string {
	ids, err := eq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(environment.FieldTenantID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Environment.Query().
//		Select(environment.FieldTenantID).
//		Scan(ctx, &v)

...
type FeatureUsageV2Repository struct {
	store  *clickhouse.ClickHouseStore
	logger *logger.Logger
}

func NewFeatureUsageV2Repository(store *clickhouse.ClickHouseStore, logger *logger.Logger) events.FeatureUsageV2Repository {
	return &FeatureUsageV2Repository{
		store:  store,
		logger: logger,
	}
}
...
func (r *FeatureUsageV2Repository) InsertProcessedEvent(ctx context.Context, event *events.FeatureUsage) error {
	query := `
...
func (r *FeatureUsageV2Repository) BulkInsertProcessedEvents(ctx context.Context, events []*events.FeatureUsage) error {
	if len(events) == 0 {
		return nil
	}
...
func (r *FeatureUsageV2Repository) GetProcessedEvents(ctx context.Context, params *events.GetProcessedEventsParams) ([]*events.FeatureUsage, uint64, error) {
	query := `
		SELECT 
			id, tenant_id, external_customer_id, customer_id, event_name, source, 
...
func (r *FeatureUsageV2Repository) IsDuplicate(ctx context.Context, subscriptionID, meterID string, periodID uint64, uniqueHash string) (bool, error) {
	query := `
		SELECT 1 
		FROM feature_usage 
...
func (r *FeatureUsageV2Repository) GetDetailedUsageAnalytics(ctx context.Context, params *events.UsageAnalyticsParams, maxBucketFeatures map[string]*events.MaxBucketFeatureInfo) ([]*events.DetailedUsageAnalytic, error) {
...
func (r *FeatureUsageV2Repository) getOtherFeatureIDs(requestedFeatureIDs []string, maxBucketFeatures map[string]*events.MaxBucketFeatureInfo) []string {
...
func (r *FeatureUsageV2Repository) getStandardAnalytics(ctx context.Context, params *events.UsageAnalyticsParams, maxBucketFeatures map[string]*events.MaxBucketFeatureInfo) ([]*events.DetailedUsageAnalytic, error) {
	...
	if params.CustomerID != "" {
		aggregateQuery += " AND customer_id = ?"
		filterParams = append(filterParams, params.CustomerID)
	}
...
func (r *FeatureUsageV2Repository) getMaxBucketAnalytics(ctx context.Context, params *events.UsageAnalyticsParams, maxBucketFeatures map[string]*events.MaxBucketFeatureInfo) ([]*events.DetailedUsageAnalytic, error) {
...
func (r *FeatureUsageV2Repository) getMaxBucketTotals(ctx context.Context, params *events.UsageAnalyticsParams, featureInfo *events.MaxBucketFeatureInfo) ([]*events.DetailedUsageAnalytic, error) {
	...
	// Add customer_id filter if provided
	if params.CustomerID != "" {
		innerQuery += " AND customer_id = ?"
		queryParams = append(queryParams, params.CustomerID)
	}
...
func (r *FeatureUsageV2Repository) getMaxBucketPointsForGroup(ctx context.Context, params *events.UsageAnalyticsParams, featureInfo *events.MaxBucketFeatureInfo, group *events.DetailedUsageAnalytic) ([]events.UsageAnalyticPoint, error) {
...
func (r *FeatureUsageV2Repository) formatWindowSize(windowSize types.WindowSize, billingAnchor *time.Time) string {
	switch windowSize {
...
func (r *FeatureUsageV2Repository) getAnalyticsPoints(
	ctx context.Context,
...
func (r *FeatureUsageV2Repository) GetFeatureUsageBySubscription(ctx context.Context, subscriptionID, externalCustomerID string, startTime, endTime time.Time) (map[string]*events.UsageByFeatureResult, error) {
...
func (r *FeatureUsageV2Repository) GetFeatureUsageForExport(ctx context.Context, startTime, endTime time.Time, batchSize int, offset int) ([]*events.FeatureUsage, error) {
	// Extract tenantID and environmentID from context
	tenantID := types.GetTenantID(ctx)
	environmentID := types.GetEnvironmentID(ctx)

...
type FeatureUsageTrackingLazyService interface {
...
type featureUsageTrackingLazyService struct {
	ServiceParams
...
func NewFeatureUsageTrackingLazyService(
	params ServiceParams,
	eventRepo events.Repository,
	featureUsageRepo events.FeatureUsageRepository,
) FeatureUsageTrackingLazyService {
	ev := &featureUsageTrackingLazyService{
	...
	backfillPubSub, err := kafka.NewPubSubFromConfig(
		params.Config,
		params.Logger,
		params.Config.FeatureUsageTrackingLazy.ConsumerGroupBackfill,
	)
	if err != nil {
...
func (s *featureUsageTrackingLazyService) PublishEvent(ctx context.Context, event *events.Event, isBackfill bool) error {
...
func (s *featureUsageTrackingLazyService) RegisterHandler(router *pubsubRouter.Router, cfg *config.Configuration) {
...
func (s *featureUsageTrackingLazyService) processMessage(msg *message.Message) error {
...
func (s *featureUsageTrackingLazyService) processEvent(ctx context.Context, event *events.Event) error {
...
func (s *featureUsageTrackingLazyService) generateUniqueHash(event *events.Event, meter *meter.Meter) string {
...
func (s *featureUsageTrackingLazyService) prepareProcessedEvents(ctx context.Context, event *events.Event) ([]*events.FeatureUsage, error) {
...
func (s *featureUsageTrackingLazyService) findMatchingPricesForEvent(
	event *events.Event,
	prices []*price.Price,
...
func (s *featureUsageTrackingLazyService) checkMeterFilters(event *events.Event, filters []meter.Filter) bool {
	if len(filters) == 0 {
...
func (s *featureUsageTrackingLazyService) extractQuantityFromEvent(
	event *events.Event,
	meter *meter.Meter,
...
func (s *featureUsageTrackingLazyService) convertValueToDecimal(val interface{}, event *events.Event, meter *meter.Meter) (decimal.Decimal, string) {
...
func (s *featureUsageTrackingLazyService) convertValueToString(val interface{}) string {
	switch v := val.(type) {
	case string:
		return v
...
func (s *featureUsageTrackingLazyService) GetDetailedUsageAnalytics(ctx context.Context, req *dto.GetUsageAnalyticsRequest) (*dto.GetUsageAnalyticsResponse, error) {
	// 1. Validate request
...
func (s *featureUsageTrackingLazyService) validateAnalyticsRequest(req *dto.GetUsageAnalyticsRequest) error {
...
func (s *featureUsageTrackingLazyService) fetchAnalyticsData(ctx context.Context, req *dto.GetUsageAnalyticsRequest) (*AnalyticsData, error) {
	// 1. Fetch customer
...
func (s *featureUsageTrackingLazyService) buildAnalyticsResponse(ctx context.Context, data *AnalyticsData) (*dto.GetUsageAnalyticsResponse, error) {
...
func (s *featureUsageTrackingLazyService) fetchCustomer(ctx context.Context, externalCustomerID string) (*customer.Customer, error) {
...
func (s *featureUsageTrackingLazyService) fetchSubscriptions(ctx context.Context, customerID string) ([]*subscription.Subscription, error) {
	subscriptionService := NewSubscriptionService(s.ServiceParams)
	filter := types.NewSubscriptionFilter()
...
func (s *featureUsageTrackingLazyService) buildMaxBucketFeatures(ctx context.Context, params *events.UsageAnalyticsParams) (map[string]*events.MaxBucketFeatureInfo, error) {
...
func (s *featureUsageTrackingLazyService) fetchAnalytics(ctx context.Context, params *events.UsageAnalyticsParams) ([]*events.DetailedUsageAnalytic, error) {
...
func (s *featureUsageTrackingLazyService) createAnalyticsParams(ctx context.Context, req *dto.GetUsageAnalyticsRequest) *events.UsageAnalyticsParams {
...
func (s *featureUsageTrackingLazyService) validateCurrency(subscriptions []*subscription.Subscription) (string, error) {
	if len(subscriptions) == 0 {
		return "", nil
	}
...
func (s *featureUsageTrackingLazyService) enrichWithMetadata(ctx context.Context, data *AnalyticsData) error {
...
func (s *featureUsageTrackingLazyService) extractUniqueFeatureIDs(analytics []*events.DetailedUsageAnalytic) []string {
...
func (s *featureUsageTrackingLazyService) fetchSubscriptionPrices(ctx context.Context, data *AnalyticsData) error {
...
func (s *featureUsageTrackingLazyService) enrichAnalyticsWithMetadata(data *AnalyticsData) {
	for _, item := range data.Analytics {
...
func (s *featureUsageTrackingLazyService) calculateCosts(ctx context.Context, data *AnalyticsData) error {
...
func (s *featureUsageTrackingLazyService) calculateBucketedCost(ctx context.Context, priceService PriceService, item *events.DetailedUsageAnalytic, price *price.Price) {
...
func (s *featureUsageTrackingLazyService) calculateRegularCost(ctx context.Context, priceService PriceService, item *events.DetailedUsageAnalytic, meter *meter.Meter, price *price.Price) {
...
func (s *featureUsageTrackingLazyService) aggregateAnalyticsByGrouping(analytics []*events.DetailedUsageAnalytic, groupBy []string) []*events.DetailedUsageAnalytic {
...
func (s *featureUsageTrackingLazyService) createGroupingKey(item *events.DetailedUsageAnalytic, groupBy []string) string {
...
func (s *featureUsageTrackingLazyService) setGroupingFields(aggregated *events.DetailedUsageAnalytic, item *events.DetailedUsageAnalytic, groupBy []string) {
	for _, group := range groupBy {
		switch group {
		case "feature_id":
...
func (s *featureUsageTrackingLazyService) mergeTimeSeriesPoints(existing []events.UsageAnalyticPoint, new []events.UsageAnalyticPoint) []events.UsageAnalyticPoint {
...
func (s *featureUsageTrackingLazyService) getCorrectUsageValue(item *events.DetailedUsageAnalytic, aggregationType types.AggregationType) decimal.Decimal {
...
func (s *featureUsageTrackingLazyService) getCorrectUsageValueForPoint(point events.UsageAnalyticPoint, aggregationType types.AggregationType) decimal.Decimal {
	switch aggregationType {
	case types.AggregationCountUnique:
...
func (s *featureUsageTrackingLazyService) ReprocessEvents(ctx context.Context, params *events.ReprocessEventsParams) error {
...
func (s *featureUsageTrackingLazyService) isSubscriptionValidForEvent(
...
func (s *featureUsageTrackingLazyService) ToGetUsageAnalyticsResponseDTO(ctx context.Context, analytics []*events.DetailedUsageAnalytic) (*dto.GetUsageAnalyticsResponse, error) {
...
func (s *featureUsageTrackingLazyService) getTotalUsageForWeightedSumAggregation(
	subscription *subscription.Subscription,
	event *events.Event,

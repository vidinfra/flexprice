...
type Repository interface {
	...
	GetByCoupon(ctx context.Context, couponID string) ([]*Redemption, error)
	GetByDiscount(ctx context.Context, discountID string) ([]*Redemption, error)
	...
	GetByTenant(ctx context.Context, tenantID string, environmentID string) ([]*Redemption, error)
}
